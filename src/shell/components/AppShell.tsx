...
export default function AppShell({ children }: AppShellProps) {
  return (
    <div className="flex h-screen bg-stone-50 dark:bg-stone-900">
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex flex-col w-[240px] bg-white dark:bg-stone-950 border-r border-stone-200 dark:border-stone-800">
        <div className="p-6 border-b border-stone-200 dark:border-stone-800">
          <h1 className="text-2xl font-bold text-primary">SnapStim</h1>
        </div>
        <div className="flex-1 overflow-y-auto py-4">
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto p-6 pt-16 md:pt-6">
          {children}
        </div>
      </main>
    </div>
